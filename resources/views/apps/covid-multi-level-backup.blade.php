						...
						<table class="table table-sm" id="page-all">
							...
							<tbody>
                                ...
                                <tr class="table-danger">
									...
									<td class="text-start" colspan="9"><b>{{$item->NamaHeader}}</b></td>
                                </tr>
                                ...
                                <tr>
									...
									<td class="text-end">{{$loop->iteration-1}}</td>
									<td class="text-start">{{$kegiatan->Uraian}} @if(!empty($kegiatan->Catatan))<br><small><i>{{$kegiatan->Catatan}}</i></small>@endif</td>
									<td class="text-center">{{$detil->SumberDana}}</td>
									<td class="text-end">{{RP($kegiatan->VolumePagu)}} {{$kegiatan->SatuanPagu}}</td>
									<td class="text-end">{{RP($kegiatan->PaguKegiatan)}}</td>
									<td class="text-end">@if(!empty($kegiatan->VolumeBelanja)){{RP($kegiatan->VolumeBelanja)}} {{$kegiatan->SatuanBelanja}} @endif</td>
