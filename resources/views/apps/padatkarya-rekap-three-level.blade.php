                        ...
                        <div class="table-responsive">
                            <table class="table table-sm sticky-header" id="card" data-show-columns="true">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($wilayah->Satker as $item)
                                    <tr>
                                        <td class="text-center">.</td>
                                        <td class="text-start">{{$item->KodeSatker}}</td>
                                    ...
                                    {{-- <tr class="table-success">
                                        ...
                                        <th class="text-center">{{RP($SumKecDaser_JumlahOrangHari)}}
                                    </tr> --}}
                                    @php
                                    ...
                                    {{-- <tr class="table-warning">
                                        <th class="text-center">..</th>
                                        <th colspan="2" class="text-start" style="padding-left:20px;">JUMLAH</th>
                                        ...
                                        <th class="text-center">{{RP($SumKabDaser_JumlahOrangHari)}}
                                    </tr> --}}
                                    @php
                                    ...
                                    <tr class="table-danger">
                                        ...
                                        <th class="text-center">{{RP($SumPropDaser_JumlahOrangHari)}}
                                    </tr>
                                    @php
                                    ...
                                    <tr class="table-primary">
                                        ...
                                        <th class="text-center">{{RP($SumTotDaser_JumlahOrangHari)}}
                                    </tr>
                                    </tfoot>
                                </tbody>
                            </table>
