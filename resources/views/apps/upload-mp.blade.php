                    ...
                    <div class="default-according style-1 mb-2" id="accordionoc">
                        <div class="card">
                          <div class="card-header bg-secondary">
                            <h5 class="mb-0">
                              <button class="btn btn-link text-white" data-bs-toggle="collapse" data-bs-target="#collapseicon{{$item->tahap ?? ''}}" aria-expanded="true" aria-controls="collapse11"><i class="icofont icofont-ship"></i>
                                MP Tahap {{$item->tahap ?? ''}}
                              </button>
                            </h5>
                          </div>
                          <div class="collapse @if ($loop->first) show @endif" id="collapseicon{{$item->tahap ?? ''}}" aria-labelledby="collapseicon" data-bs-parent="#accordionoc">
			...
			<div class="card">
				...
				<div class="card-body">
                    ...
                    <form id="myform" action="{{ route('save/upload') }}" method="post" enctype="multipart/form-data">
                        ...
                        <input type="hidden" name="tahap" value="{{count($data)}}">
