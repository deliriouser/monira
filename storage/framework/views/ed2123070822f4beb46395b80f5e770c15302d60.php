                    ...
                    <div class="default-according style-1 mb-2" id="accordionoc">
                        <div class="card">
                          <div class="card-header bg-secondary">
                            <h5 class="mb-0">
                              <button class="btn btn-link text-white" data-bs-toggle="collapse" data-bs-target="#collapseicon<?php echo e($item->Belanja); ?>" aria-expanded="true" aria-controls="collapse11"><i class="icofont icofont-cart"></i>
                             <?php echo e(belanja($item->Belanja)); ?>

                              </button>
                            </h5>
                          </div>
                          <div class="collapse show" id="collapseicon<?php echo e($item->Belanja); ?>" aria-labelledby="collapseicon" data-bs-parent="#accordionoc">
...
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/user/dev/app-monira/resources/views/apps/upload-realisasi.blade.php ENDPATH**/ ?>