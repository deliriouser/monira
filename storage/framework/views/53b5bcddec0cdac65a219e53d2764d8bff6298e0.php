...
<html lang="en">
  <head>
    ...
    <link rel="shortcut icon" href="<?php echo e(asset('assets/images/favicon.ico')); ?>" type="image/x-icon">
     <title>:: MONIRA - MONITORING INFORMASI dan REALISASI ANGGARAN <?php echo $__env->yieldContent('title'); ?></title>
    <!-- Google font-->
...
<?php /**PATH /Users/user/dev/app-monira/resources/views/layouts/authentication/master.blade.php ENDPATH**/ ?>