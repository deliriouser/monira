                            ...
                            <table class="table table-sm" id="card">
                                ...
                                <tbody>
                                    ...
                                    <tr class="table-warning">
                                        ...
                                        <th class="text-end"></th>
                                        <th class="text-end"><?php echo e(RP($totalpaguSatker)); ?></th>
                                        <th class="text-end"><?php echo e(RP($totaldsaSatker)); ?></th>
                                        <th class="text-center"><?php echo e(Persen(divnum($totaldsaSatker,$totalpaguSatker)*100)); ?>%</th>
                                        <th class="text-end"><?php echo e(RP($totalsisaSatker)); ?></th>
                                    </tr>
...
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/user/dev/app-monira/resources/views/apps/padatkarya-three-level.blade.php ENDPATH**/ ?>