              ...
              <div class="row">
                <div class="col-xl-4 col-md-12 box-md-12 pr-0">
                  ...
                  <div class="inbox ps ps--active-y">
                    ...
                    <div class="media openmessageSatker <?php echo e(isRead($item->IsRead)); ?>" id="<?php echo e($item->IdMessage); ?>">
                        ...
                        <div class="media-body">
                          <h6 class="text-primary">Admin
                              ...
                              <?php echo e(\Carbon\Carbon::parse($item->created_at)->isoFormat('D MMMM YYYY')); ?>

                            </small>
                        </h6>
                          <p><?php echo e($item->Message->Subject); ?></p>
                        </div>
                      </div>
                ...
                <div class="col-xl-8 col-md-12 box-md-12 pl-0 bg-content email-blank">
                  <div class="email-right-aside">
...
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/user/dev/app-monira/resources/views/apps/inbox.blade.php ENDPATH**/ ?>