                        ...
                        <div class="col-3 text-end dropup-basic">
                            <div class="export">
                                ...
                                <div class="export-content">
                                    <a target="_blank" href="<?php echo e(route(Auth::user()->ba.'/report',['type'=>'excell','unit'=>'eselon1','segment'=>'belanja'])); ?>">Excell</a>
                                    <a target="_blank" href="<?php echo e(route(Auth::user()->ba.'/report',['type'=>'pdf','unit'=>'eselon1','segment'=>'belanja'])); ?>">PDF</a>
                                </div>
                            </div>
                        </div>
                    </div>
                      ...
                      <table class="table">
                        ...
                        <tfoot class="table-primary">
                            <tr>
                              ...
                              <th class="text-center"><?php echo e(Persen(divnum($DashBelanja->sum('Realisasi'),$DashBelanja->sum('Pagu'))*100)); ?>%</th>
                            </tr>
                          </tfoot>
                      </table>
              </div>
                ...
                <div class="row">
                    ...
                    <div class="col-3 text-end dropup-basic">
                        <div class="export">
                            <i data-feather="printer" class="exportbtn text-primary"></i>
                            <div class="export-content">
                                <a target="_blank" href="<?php echo e(route(Auth::user()->ba.'/report',['type'=>'excell','unit'=>'eselon1','segment'=>'kegiatan'])); ?>">Excell</a>
                                <a target="_blank" href="<?php echo e(route(Auth::user()->ba.'/report',['type'=>'pdf','unit'=>'eselon1','segment'=>'kegiatan'])); ?>">PDF</a>
                            </div>
                        </div>
                    </div>
                </div>
                      ...
                      <table class="table">
                        ...
                        <tfoot class="table-primary">
                            <tr>
                              ...
                              <th class="text-center"><?php echo e(Persen(divnum($DashKegiatan->sum('Realisasi'),$DashKegiatan->sum('Pagu'))*100)); ?>%</th>
                            </tr>
                          </tfoot>
                      </table>
              </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-3 text-end dropup-basic">
                            <div class="export">
                                <i data-feather="printer" class="exportbtn text-primary"></i>
                                <div class="export-content">
                                    <a target="_blank" href="<?php echo e(route(Auth::user()->ba.'/report',['type'=>'excell','unit'=>'eselon1','segment'=>'sumberdana'])); ?>">Excell</a>
                                    <a target="_blank" href="<?php echo e(route(Auth::user()->ba.'/report',['type'=>'pdf','unit'=>'eselon1','segment'=>'sumberdana'])); ?>">PDF</a>
                                </div>
                            </div>
                        </div>
                    </div>
                      ...
                      <table class="table">
                        ...
                        <thead class="table-primary">
                            <tr>
                              ...
                              <th class="text-center"><?php echo e(Persen(divnum($DashSDana->sum('Realisasi'),$DashSDana->sum('Pagu'))*100)); ?>%</th>
                            </tr>
                          </thead>
                      </table>
              </div>
...
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/user/dev/app-monira/resources/views/dashboard/belanja.blade.php ENDPATH**/ ?>