                    ...
                    <div class="default-according style-1 mb-2" id="accordionoc">
                        <div class="card">
                          <div class="card-header bg-secondary">
                            <h5 class="mb-0">
                              <button class="btn btn-link text-white" data-bs-toggle="collapse" data-bs-target="#collapseicon<?php echo e($item->bulan); ?>" aria-expanded="true" aria-controls="collapse11"><i class="icofont icofont-wallet"></i>
                             <?php echo e(nameofmonth($item->month)); ?>
...
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/user/dev/app-monira/resources/views/apps/upload-penerimaan.blade.php ENDPATH**/ ?>