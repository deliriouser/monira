                        ...
                        <div class="col-3 text-end">
                            ...
                            <div class="export">
                                ...
                                <div class="export-content">
                                    <a target="_blank" href="<?php echo e(route(Auth::user()->ba.'/report',['type'=>'excell','unit'=>'propinsi','segment'=>'ranking'])); ?>">Excell</a>
                                    <a target="_blank" href="<?php echo e(route(Auth::user()->ba.'/report',['type'=>'pdf','unit'=>'propinsi','segment'=>'ranking'])); ?>">PDF</a>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/user/dev/app-monira/resources/views/apps/ranking-propinsi.blade.php ENDPATH**/ ?>