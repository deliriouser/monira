    ...
    <table class="table table-sm" id="page-all">
        ...
        <tbody>
            ...
            <tr class="table-danger">
                ...
                <td class="text-start" colspan="7"><b><?php echo e(strtoupper($item->NamaHeader)); ?></b></td>
            </tr>
...
<?php /**PATH /Users/user/dev/app-monira/resources/views/reports/report-pdf-prognosa-satker.blade.php ENDPATH**/ ?>