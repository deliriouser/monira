							...
							<tbody>
                                ...
                                <?php if(isset($item->KodeHeader)): ?>
                                    ...
                                    <tr class="table-danger">
                                        <td class="text-start"><?php echo e($item->KodeHeader); ?></td>
                                        <td class="text-start text-bold" colspan="5"><?php echo e(strtoupper($item->NamaHeader)); ?></td>
                                    </tr>
                                    <?php endif; ?>
                                <?php endif; ?>
...
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/user/dev/app-monira/resources/views/apps/belanja-eselon1-bk.blade.php ENDPATH**/ ?>