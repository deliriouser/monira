                        ...
                        <div class="table-responsive">
                            <table class="table table-sm sticky-header" id="card" data-show-columns="true">
                                ...
                                <tbody>
                                    ...
                                    <?php $__currentLoopData = $wilayah->Kabupaten; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kabupaten): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="table-warning">
                                        <th class="text-center">.</th>
                                        <th class="text-start" colspan="13" style="padding-left:20px;"><?php echo e($kabupaten->Kabupaten); ?></th>
                                    </tr>
                                    <?php
                                    ...
                                    <?php $__currentLoopData = $kabupaten->Kecamatan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kecamatan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="table-success">
                                        <th class="text-center">..</th>
                                        <th class="text-start" colspan="13" style="padding-left:40px;">KEC. <?php echo e($kecamatan->Kecamatan); ?></th>
                                    </tr>
                                    <?php
                                    ...
                                    <?php $__currentLoopData = $kecamatan->Desa; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td class="text-center">...</td>
                                        <td class="text-start" style="padding-left:60px;">DES. <?php echo e($item->Desa); ?></td>
                                    ...
                                    <tr class="table-success">
                                        <th class="text-center">...</th>
                                        <th colspan="2" class="text-start" style="padding-left:40px;">JUMLAH KEC. <?php echo e($kecamatan->Kecamatan); ?></th>
                                        <th class="text-end"><?php echo e(RP($SumKecTarget_TotalPagu)); ?></th>
                                        <th class="text-end"><?php echo e(RP($SumKecTarget_TotalBiayaLain)); ?></th>
                                        <th class="text-end"><?php echo e(RP($SumKecTarget_TotalBiayaUpah)); ?></th>
                                        <th class="text-center"><?php echo e(RP($SumKecTarget_JumlahOrang)); ?></th>
                                        <th class="text-center"><?php echo e(RP($SumKecTarget_JumlahOrangHari)); ?></th>
                                        <th class="text-end"></th>
                                        <th class="text-end"><?php echo e(RP($SumKecDaser_TotalPagu)); ?></th>
                                        <th class="text-end"><?php echo e(RP($SumKecDaser_TotalBiayaLain)); ?></th>
                                        <th class="text-end"><?php echo e(RP($SumKecDaser_TotalBiayaUpah)); ?></th>
                                        <th class="text-center"><?php echo e(RP($SumKecDaser_JumlahOrang)); ?></th>
                                        <th class="text-center"><?php echo e(RP($SumKecDaser_JumlahOrangHari)); ?></th>
                                    </tr>
                                    <?php
                                    ...
                                    <tr class="table-warning">
                                        <th class="text-center">..</th>
                                        <th colspan="2" class="text-start" style="padding-left:20px;">JUMLAH <?php echo e($kabupaten->Kabupaten); ?></th>
                                        <th class="text-end"><?php echo e(RP($SumKabTarget_TotalPagu)); ?></th>
                                        <th class="text-end"><?php echo e(RP($SumKabTarget_TotalBiayaLain)); ?></th>
                                        <th class="text-end"><?php echo e(RP($SumKabTarget_TotalBiayaUpah)); ?></th>
                                        <th class="text-center"><?php echo e(RP($SumKabTarget_JumlahOrang)); ?></th>
                                        <th class="text-center"><?php echo e(RP($SumKabTarget_JumlahOrangHari)); ?></th>
                                        <th class="text-end"></th>
                                        <th class="text-end"><?php echo e(RP($SumKabDaser_TotalPagu)); ?></th>
                                        <th class="text-end"><?php echo e(RP($SumKabDaser_TotalBiayaLain)); ?></th>
                                        <th class="text-end"><?php echo e(RP($SumKabDaser_TotalBiayaUpah)); ?></th>
                                        <th class="text-center"><?php echo e(RP($SumKabDaser_JumlahOrang)); ?></th>
                                        <th class="text-center"><?php echo e(RP($SumKabDaser_JumlahOrangHari)); ?></th>
                                    </tr>
                                    <?php
                                    ...
                                    <tr class="table-danger">
                                        <th class="text-center"></th>
                                        <th colspan="2" class="text-start" style="padding-left:0px;">TOTAL <?php echo e($wilayah->NamaWilayah); ?></th>
                                        ...
                                        <th class="text-center"><?php echo e(RP($SumPropDaser_JumlahOrangHari)); ?></th>
                                    </tr>
                                    <?php
                                    ...
                                    <tr class="table-primary">
                                        ...
                                        <th class="text-center"><?php echo e(RP($SumTotDaser_JumlahOrangHari)); ?></th>
                                    </tr>
                                    </tfoot>
                                </tbody>
                            </table>
...
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/user/dev/app-monira/resources/views/apps/padatkarya-rekap-two-level.blade.php ENDPATH**/ ?>