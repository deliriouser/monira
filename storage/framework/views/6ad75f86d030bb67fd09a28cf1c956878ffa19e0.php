    ...
    <tr>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-end"><?php echo e(($Akun->Pagu)); ?></td>
                <td class="text-end"><?php echo e(($Akun->Dsa)); ?></td>
                <td class="text-center"><?php echo e(Persen($Akun->Persen)); ?>%</td>
                <td class="text-end"><?php echo e(($Akun->Sisa)); ?></td>
            ...
            <tr>
                ...
                <th class="text-center"></th>
                <th class="text-end"><?php echo e(($totalpaguProp)); ?></th>
                <th class="text-end"><?php echo e(($totaldsaProp)); ?></th>
                <th class="text-center"><?php echo e(Persen(divnum($totaldsaProp,$totalpaguProp)*100)); ?>%</th>
                <th class="text-end"><?php echo e(($totalsisaProp)); ?></th>
            </tr>
        ...
        <tfoot class="table-primary">
            <tr>
                ...
                <th class="text-end"><?php echo e(($totaldsa)); ?></th>
                <th class="text-center"><?php echo e(Persen(divnum($totaldsa,$totalpagu)*100)); ?>%</th>
                <th class="text-end"><?php echo e(($totalsisa)); ?></th>
            </tr>
        </tfoot>
    </table>
<?php /**PATH /Users/user/dev/app-monira/resources/views/reports/report-excell-padatkarya-two-level.blade.php ENDPATH**/ ?>